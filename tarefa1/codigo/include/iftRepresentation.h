...
iftFImage *iftMSSkel2DDistMap(const iftImage *label_img, const iftAdjRel *A, iftSide side, iftImage **dist_out,
...
iftFImage *iftMSSkel2D(const iftImage *label_img, const iftAdjRel *A, char side, iftImage **dist_out,
                       iftImage **relabel_img_out);
 ...
 */
iftFImage *iftLabelContourPixelByGeoLen(const iftImage *label_img);
