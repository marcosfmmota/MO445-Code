...
/**
 * @brief Draws a legend in an image containing a white box with small boxes inside (one per each color
 * in the color table from firstColor to lastColor)
 * @author Cesar Castelo
 * @date Set 18, 2018
 *
 ...
 */
void iftDrawColorLegend(iftImage *img, iftColorTable *ctb, int firstColor, int lastColor, char *location);
