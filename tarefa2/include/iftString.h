...
/**
 * @brief Compares two strings ignoring case of letters.
 * @author Peixinho
 * @date Nov, 2017
 * @ingroup String
 *
 ...
 */
bool iftCompareStringsIgnoreCase(const char *str1, const char *str2);
...
/**
 * @brief Searches for the first occurrence of the character in the string.
 ...
 * @return NIL if the character is not found, or the first position in which it appears in the string.
 */
long iftFindStringCharacter(const char *str, char character);


/**
 * @brief Verifies if the string is strictly composed of numerical characters.
 * @author Thiago Vallin Spina
 * @date Mar 9, 2016
 * @ingroup String
 * 
 * @note '.' is not considered as a numerical character and neither is '', following the Python convention.
 *
 * @param str The string to be evaluated
 * @return True if all chracters in str are numerical
 */
bool iftIsDigit(const char *str);
