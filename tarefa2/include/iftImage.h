...
/**
 * @brief Reads an array of images from a file set.
 * @author Samuel Martins
 * @date Aug 31, 2018
 */
iftImageArray *iftReadImageArray(const iftFileSet *img_set);
 ...
 * @date Oct 31, 2017
 */
void iftMinMaxValue(const iftImage *img, int *min, int *max);
 ...
 * 
 * Given an label image with some object missing (for example, it only has the objects 1 and 3, missing the 2)
 * to the incremental order.
 * 
...
/**
 * @brief Move the object to the center of the image
 * @param label_img Input label image
 * @author Azael de Melo e Sousa
 * @return A new label image where the object is located on the center of the image
 */
iftImage *iftCentralizeObject(iftImage *label);
