...
inline void iftCopyGenericMatrixRowGivenLines(iftGenericMatrix* matrix1,iftGenericMatrix* matrix2, size_t rowIndex1,size_t rowIndex2){
...
inline void iftSetRowValueGivenVector(iftGenericMatrix* matrix, iftGenericVector* vector, size_t rowIndex){
...
inline void iftCopyGenericMatrixRow(iftGenericMatrix* matrix1,iftGenericMatrix* matrix2, size_t rowIndex1){
