...
/** Samuel Martins and Azael Sousa only add new comments to this struct. All field were kept. */
                        /*************************/  /************************/
struct nifti_1_header { /* NIFTI-1 usage         */    /* ANALYZE 7.5 field(s) */  /* offset + size */ /* meaning in ANALYZE 7.5 */
                        /*************************/    /************************/

                                                        /* it was header_key
                                                                      substruct */ 
    int   sizeof_hdr;    /*!< MUST be 348           */  /* int sizeof_hdr;      */ /* 0 + 4 */         /* Must indicate the byte size of the header file = 348 bytes */ 
    char  data_type[10]; /*!< ++UNUSED++            */  /* char data_type[10];  */ /* 4 + 10 */
    char  db_name[18];   /*!< ++UNUSED++            */  /* char db_name[18];    */ /* 14 + 18 */
    int   extents;       /*!< ++UNUSED++            */  /* int extents;         */ /* 32 + 4 */       /* Should be 16384, the image file is created as contiguous with a minimum extent size. */ 
    short session_error; /*!< ++UNUSED++            */  /* short session_error; */ /* 36 + 2 */
    char  regular;       /*!< ++UNUSED++            */  /* char regular;        */ /* 38 + 1 */       /* Must be `r' to indicate that all images and volumes are the same size. */
    char  dim_info;      /*!< MRI slice ordering.   */  /* char hkey_un0;       */ /* 39 + 1 */
    /* total = 40 bytes */ 

                                                        /* it was image_dimension
                                                           substruct */
    /** 
     * Array of the image dimension.
     ...
     */
    short dim[8];        /*!< Data array dimensions.*/  /* short dim[8];        */ /* 40 + 16 */ 
    float intent_p1 ;    /*!< 1st intent parameter. */  /* short unused8;       */ /* 56 + 4 */
                                                        /* short unused9;       */
    float intent_p2 ;    /*!< 2nd intent parameter. */  /* short unused10;      */ /* 60 + 4 */
                                                        /* short unused11;      */
    float intent_p3 ;    /*!< 3rd intent parameter. */  /* short unused12;      */ /* 64 + 4 */
                                                        /* short unused13;      */
    short intent_code ;  /*!< NIFTI_INTENT_* code.  */  /* short unused14;      */ /* 68 + 2 */
    short datatype;      /*!< Defines data type!    */  /* short datatype;      */ /* 70 + 2 */
    short bitpix;        /*!< Number bits/voxel.    */  /* short bitpix;        */ /* 72 + 2 */      /* number of bits per pixel; 1, 8, 16, 32, or 64 */ 
    short slice_start;   /*!< First slice index.    */  /* short dim_un0;       */ /* 74 + 2 */
    float pixdim[8];     /*!< Grid spacings.        */  /* float pixdim[8];     */ /* 76 + 32 */     /** pixdim[] specifies the voxel dimensitons:
                                                                                                       * pixdim[1] = voxel width in mm 
                                                                                                       * pixdim[2] = voxel height in mm 
                                                                                                       * pixdim[3] = slice thickness in mm 
                                                                                                       */
    float vox_offset;    /*!< Offset into .nii file */  /* float vox_offset;    */ /* 108 + 4 */     /* Byte offset in the .img or nii file at which data voxels start.
                                                                                                      * This value can negative to specify that the absolute value is applied for every image in the file. 
                                                                                                      */
    float scl_slope ;    /*!< Data scaling: slope.  */  /* float funused1;      */ /* 112 + 4 */
    float scl_inter ;    /*!< Data scaling: offset. */  /* float funused2;      */ /* 116 + 4 */
    short slice_end;     /*!< Last slice index.     */  /* float funused3;      */ /* 120 + 4 */
    char  slice_code ;   /*!< Slice timing order.   */
    char  xyzt_units ;   /*!< Units of pixdim[1..4] */
    float cal_max;       /*!< Max display intensity */  /* float cal_max;       */ /* 124 + 4 */     /* Specify the range of calibration values */
    float cal_min;       /*!< Min display intensity */  /* float cal_min;       */ /* 128 + 4 */     /* Specify the range of calibration values */
    float slice_duration;/*!< Time for 1 slice.     */  /* float compressed;    */ /* 132 + 4 */
    float toffset;       /*!< Time axis shift.      */  /* float verified;      */ /* 136 + 4 */
    int   glmax;         /*!< ++UNUSED++            */  /* int glmax;           */ /* 140 + 4 */     /* The maximum and minimum pixel values for the entire analyze image. */
    int   glmin;         /*!< ++UNUSED++            */  /* int glmin;           */ /* 144 + 4 */     /* The maximum and minimum pixel values for the entire analyze image. */
    /* total = 148 bytes */


                                                        /* it was data_history
                                                           substruct */
    char  descrip[80];   /*!< any text you like.    */  /* char descrip[80];    */ /* 148 + 80 */
    char  aux_file[24];  /*!< auxiliary filename.   */  /* char aux_file[24];   */ /* 228 + 24 */

    // all ANALYZE 7.5 fields from here are replaced */                            /* 252 + 2 */
    short qform_code ;   /*!< NIFTI_XFORM_* code.   */                             /* 254 + 2 */
    short sform_code ;   /*!< NIFTI_XFORM_* code.   */  
                                                        
    float quatern_b ;    /*!< Quaternion b param.   */                             /* 256 + 4 */
    float quatern_c ;    /*!< Quaternion c param.   */                             /* 260 + 4 */
    float quatern_d ;    /*!< Quaternion d param.   */                             /* 264 + 4 */
    float qoffset_x ;    /*!< Quaternion x shift.   */                             /* 268 + 4 */
    float qoffset_y ;    /*!< Quaternion y shift.   */                             /* 272 + 4 */
    float qoffset_z ;    /*!< Quaternion z shift.   */                             /* 276 + 4 */

    float srow_x[4] ;    /*!< 1st row affine transform.   */                       /* 280 + 16 */
    float srow_y[4] ;    /*!< 2nd row affine transform.   */                       /* 296 + 16 */
    float srow_z[4] ;    /*!< 3rd row affine transform.   */                       /* 312 + 16 */

    char intent_name[16];/*!< 'name' or meaning of data.  */                       /* 328 + 16 */

    char magic[4] ;      /*!< MUST be "ni1\0" or "n+1\0". */                       /* 344 + 4 */
    /* total = 248 bytes */
