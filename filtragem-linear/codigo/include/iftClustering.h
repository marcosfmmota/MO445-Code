...
/**
 * @brief Computes centroids from a previously clustered iftDataSet. If realCentroids is TRUE, it returns the closest
 ...
 * @param returnRealCent Whether or not to return the real centroids
 * @param decrement_groups If TRUE, the group number is decremented by 1
 * @return A dataset with the centroids
 * @author Cesar Castelo
 * @date Abr 23, 2018
 */
iftDataSet* iftComputeCentroidsFromDataSetAsDataSet(iftDataSet *Z, bool returnRealCent, bool decrement_groups);
 ...
 * @param returnRealCent Whether or not to return the real centroids
 * @param decrement_groups If TRUE, the group number is decremented by 1
 * @return A matrix with the centroids
 * @author Cesar Castelo
 * @date Abr 23, 2018
 */
iftMatrix* iftComputeCentroidsFromDataSetAsMatrix(iftDataSet *Z, bool returnRealCent, bool decrement_groups);
